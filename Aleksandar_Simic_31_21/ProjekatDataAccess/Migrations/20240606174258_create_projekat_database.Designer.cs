...
namespace ProjekatDataAccess.Migrations
{
    ...
    [Migration("20240606174258_create_projekat_database")]
    partial class create_projekat_database
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjekatDomain.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjekatDomain.User", b =>
                {
                    b.HasOne("ProjekatDomain.Role", "Role")
                        .WithMany("Users")
